...
export class StudentService {
  ...
  protected convertDateFromClient(student: IStudent): IStudent {
    const copy: IStudent = Object.assign({}, student, {
      ...
      lastAccess: student.lastAccess && student.lastAccess.isValid() ? student.lastAccess.toJSON() : undefined,
    });
    return copy;
  }
  ...
  protected convertDateArrayFromServer(res: EntityArrayResponseType): EntityArrayResponseType {
    if (res.body) {
      res.body.forEach((student: IStudent) => {
        ...
        student.lastAccess = student.lastAccess ? moment(student.lastAccess) : undefined;
      });
    }
    return res;
  }
