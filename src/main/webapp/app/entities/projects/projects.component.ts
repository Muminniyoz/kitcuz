...
export class ProjectsComponent implements OnInit, OnDestroy {
  ...
  loadAll(): void {
    this.projectsService
      ...
      .subscribe((res: HttpResponse<IProjects[]>) => this.paginateProjects(res.body, res.headers));
  }
  ...
  registerChangeInProjects(): void {
    this.eventSubscriber = this.eventManager.subscribe('projectsListModification', () => this.reset());
  }
  ...
  protected paginateProjects(data: IProjects[] | null, headers: HttpHeaders): void {
