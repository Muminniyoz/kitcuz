...
export class TeacherService {
  ...
  protected convertDateFromClient(teacher: ITeacher): ITeacher {
    const copy: ITeacher = Object.assign({}, teacher, {
      ...
      lastAccess: teacher.lastAccess && teacher.lastAccess.isValid() ? teacher.lastAccess.toJSON() : undefined,
  ...
  protected convertDateArrayFromServer(res: EntityArrayResponseType): EntityArrayResponseType {
    if (res.body) {
      res.body.forEach((teacher: ITeacher) => {
        ...
        teacher.lastAccess = teacher.lastAccess ? moment(teacher.lastAccess) : undefined;
