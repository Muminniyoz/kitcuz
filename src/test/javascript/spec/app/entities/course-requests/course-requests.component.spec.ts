...
import { CourseRequestsComponent } from 'app/entities/course-requests/course-requests.component';
...
describe('Component Tests', () => {
  describe('CourseRequests Management Component', () => {
    let comp: CourseRequestsComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(CourseRequestsComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.courseRequests && comp.courseRequests[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
