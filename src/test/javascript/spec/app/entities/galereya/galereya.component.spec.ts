...
import { GalereyaComponent } from 'app/entities/galereya/galereya.component';
...
describe('Component Tests', () => {
  describe('Galereya Management Component', () => {
    let comp: GalereyaComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(GalereyaComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.galereyas && comp.galereyas[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
